...
import com.designpattern.deckerpattern.basicclass.FruitJuice;
...
/**
 * @program: patterntest
 * @description: 苹果汁，果汁的一种,装饰者的实现类，继承果汁抽象类，
 * @author: Mr.Yang
...
public class AppleJuice extends FruitJuice {
    ...
    //苹果汁的描述
    private final static String name="苹果汁";

    //苹果汁的对外成本价
    private final static double orangePrice=2.2;

    //让水(被装饰者)记录到变量中
    Water water;

    public AppleJuice(Water water){
        this.water=water;
    }
